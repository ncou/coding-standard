...
// @TODO : This class has been extracted from Code_Sniffer (use PHP_CodeSniffer\Tests\Standards\AbstractSniffUnitTest;) 
// and modified because the typehint "protected function setUp(): void" was not defined. You can remove this class 
// once code sniffer support php8 (it's in the future v4.x version !!!!).
