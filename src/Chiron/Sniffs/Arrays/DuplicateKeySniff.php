...
/**
 * Ensure that associative arrays doesn't contain duplicate keys.
 *
 * @see https://github.com/webimpress/coding-standard/blob/master/src/WebimpressCodingStandard/Sniffs/Arrays/DuplicateKeySniff.php
 */
