...
namespace Chiron\Sniffs\Classes;
 ...
 *
 * @see https://github.com/VincentLanglet/symfony-custom-coding-standard/blob/master/SymfonyCustom/Sniffs/Classes/PropertyDeclarationSniff.php
 */
